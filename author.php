...
<?php rewind_posts(); ?>
     ...
     <?php while (have_posts()) : the_post(); ?>										
			<div class="post">            	
                ...
                <small><?php _e('Posted by','nattywp'); ?> <span class="author"><?php the_author() ?></span> <?php _e('in','nattywp'); ?> <?php the_category(' | ');?> - (<?php comments_popup_link(__('0 Comments', 'nattywp'), __('1 Comments', 'nattywp'), __('% Comments', 'nattywp')); ?>)</small> <?php edit_post_link(__('Edit','nattywp'), ' | ', ''); ?>
                </div>              
				<div class="entry">
          <?php
