...
<div id="product-action">
	...
	<table>
		...
		<td><span class="selected"><a href="gutterglove-pro"><img src="<?php echo get_template_directory_uri(); ?>/images/gutterglove_pro_bttn_action.png" alt="Gutterglove Pro" /></a></span></td>
